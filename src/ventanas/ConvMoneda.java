...
/**
 * Clase que muestra la interfaz gráfica de la conversión de monedas
 * @author NICOLE
 */
...
/**
 *  Crea una instancia de la clase moneda
 */
    public ConvMoneda() {
        initComponents();
        setSize(400, 600);
 ...
 */   
   @Override 
    ...
    private void initComponents() {
        ...
        jTextField_MonedaConv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_MonedaConvActionPerformed(evt);
            }
        });
    ...
    private void jTextField_MonedaConvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_MonedaConvActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_MonedaConvActionPerformed

    /**
     * Inicia la aplicacion de conversion de monedas. 
     * Configura el aspecto de interfaz de usuario usando lo que es el look and feel Nimbus, si es que está disponible.
     * Dado eso crea la instancia gráfica principal para realizar las conversiones.
